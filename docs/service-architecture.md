...
- **Lane:** Incident operations cockpit
- **Primary buyer:** SOC, NOC, SRE, and infrastructure teams managing incident handoff
- **First motion:** Tabletop scenario and incident workflow mapping

## Recommended Architecture

Cloudflare Pages for UI, Workers or container API for incident workflows, Postgres for cases, R2 for evidence attachments, queue for report generation.
...
- R2 credentials
- AUTH_SECRET
- incident integration tokens later
...
- synthetic incidents until buyer approval
- attachment redaction
- role-based access before real incidents
