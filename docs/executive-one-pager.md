...
- compresses screenshot + log evidence into an inspectable incident report
- exposes a deterministic replay evidence path before technical evaluators trust the live model path
