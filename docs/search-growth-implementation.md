...
| Lead capture URL | https://kim3310-doeon-kim-portfolio.pages.dev/?offer=AegisOps&inquiry=incident-operations-exercise#private-inquiry |
| Repository resource route | https://kim3310-doeon-kim-portfolio.pages.dev/resources/AegisOps/ |
...
- The lead-capture path is the central Cloudflare D1 private inquiry form at https://kim3310-doeon-kim-portfolio.pages.dev/?offer=AegisOps&inquiry=incident-operations-exercise#private-inquiry; public GitHub issues are not used for confidential or commercial scoping.
