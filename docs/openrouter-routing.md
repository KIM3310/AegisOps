...
| Lane | Model | Purpose |
|---|---|---|
| Primary | `anthropic/claude-sonnet-4.6` | Multimodal incident analysis, postmortem drafting, and follow-up Q&A. |
...
OPENROUTER_HTTP_REFERER=https://aegisops-ai-incident-doctor.pages.dev
OPENROUTER_APP_TITLE=AegisOps
```
