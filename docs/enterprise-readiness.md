...
This note defines what an enterprise security approver, public-sector operator, serious user, or technical evaluator can safely infer from this repository today. It is intentionally conservative: public proof is separated from production claims.
...
- `npm run architecture:smoke` passes
