...
- Review 25 redacted secret-pattern finding(s) from the audit index before publishing or deploying.
...
- Redacted audit has 25 possible secret-pattern finding(s); manually review before publication or deploy.
