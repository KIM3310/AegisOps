# Architecture Guide - AegisOps -- Multimodal Incident Review System
...
|---|---|
| Incident-review tabletop package | Scope after product intake |
| Managed replay/eval setup for customer incidents | Scope after product intake |
| Monthly incident-quality scorecard and operator handoff review | Scope after product intake |
