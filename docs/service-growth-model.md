...
| Field | Decision |
|---|---|
| Service type | Incident operations cockpit |
| Primary reader or buyer | SOC, NOC, SRE, and infrastructure teams managing incident handoff. |
| Wedge | Tabletop scenario and incident workflow mapping. |
